...
<br>
<br>
![alt text](README_visuals/star_schema.png)
...
![alt text](README_visuals/5.1_grouped_cards.png)

See below for finished headline card visuals:

![alt text](README_visuals/5.1_headline_cards.png)
...
![alt text](README_visuals/5.2_donut_chart.png)

See Column Chart below:

![alt text](README_visuals/5.2_column_chart.png)
...
![alt text](README_visuals/5.3_line_chart.png)
...
![alt text](README_visuals/5.4_topn_filter.png)
...
![alt text](README_visuals/5.6_date_slicer.png)

See below how **Customer Detail** report page looks as a whole:

![alt text](README_visuals/Customer_Detail_page.png)
...
![alt text](README_visuals/6.1_card_visuals.png)
...
<br>
![alt text](README_visuals/6.2_revenue_trending_line_chart(1).png)

<ins>Start of Quarter</ins>:

![alt text](README_visuals/6.2_revenue_trending_line_chart(2).png)

<ins>Start of Month</ins>:

![alt text](README_visuals/6.2_revenue_trending_line_chart(3).png)
...
![alt text](README_visuals/6.3_donut_charts.png)
...
![alt text](README_visuals/6.4_bar_chart.png)
...
![alt text](README_visuals/7.1_gauge_conditional_formating.png)

See the finished gauge visuals below:

![alt text](README_visuals/7.1_gauges.png)
...
<br>
<br>
![alt text](README_visuals/7.2_groups.png)
<br>
<br>
...
<br>
<br>
![alt text](README_visuals/7.2_filter_state_cards.png)
...
![alt text](README_visuals/7.3_area_chart_settings.png)

See the completed area chart visual below for different date hierarchy levels:

<ins>Start of Year</ins>:

![alt text](README_visuals/7.3_area_chart(1).png)

<ins>Start of Quarter</ins>:

![alt text](README_visuals/7.3_area_chart(2).png)

<ins>Start of Month</ins>:

![alt text](README_visuals/7.3_area_chart(3).png)

<ins>Start of Day</ins>:

![alt text](README_visuals/7.3_area_chart(4).png)
...
![alt text](README_visuals/7.6_open_slicer_panel_button.png)
<br>
...
![alt text](README_visuals/7.6_group3.png)

See the complete slicer toolbar below:

![alt text](README_visuals/7.6_slicer_toolbar.png)
...
![alt text](README_visuals/7.6_bookmark_settings.png)
...
![alt text](README_visuals/7.6_back_button_action.png) ![alt text](README_visuals/7.6_open_slicer_panel_button_action.png)
...
![alt text](README_visuals/Product_Detail_page.png)
...
<br>
![alt text](README_visuals/8.1_map_visual(1).png)

<ins>By Country</ins>:
<br>
![alt text](README_visuals/8.1_map_visual(2).png)

<ins>By World Region</ins>:
<br>
![alt text](README_visuals/8.1_map_visual(3).png)
...
![alt text](README_visuals/8.2_country_slicer.png)
...
![alt text](README_visuals/8.3_table.png)
...
![alt text](README_visuals/8.3_column_chart.png)
...
![alt text](README_visuals/8.3_gauge_visuals.png)
...
![alt text](README_visuals/8.3_selection_card_visual.png)

See below the completed Store Drillthrough page:

![alt text](README_visuals/Store_Drillthrough_page.png)
...
![alt text](README_visuals/Dashboard_Icon.png) &emsp;&emsp; ![alt text](README_visuals/Dashboard_Icon_Black.png)

Customer Detail page icon:

![alt text](README_visuals/Customer_Icon.png) &emsp;&emsp; ![alt text](README_visuals/Customer_Icon_Black.png)

Product Detail page icon:

![alt text](README_visuals/Product_Icon.png) &emsp;&emsp; ![alt text](README_visuals/Product_Icon_Black.png)

Stores Map page icon:

![alt text](README_visuals/Map_Icon.png) &emsp;&emsp; ![alt text](README_visuals/Map_Icon_Black.png)
...
![alt text](README_visuals/9.2_button_tooltip.png)
...
![alt text](README_visuals/Navigation_Bar.png)
...
<br>
<br>
![alt text](README_visuals/Executive_Summary_page(1).png)
<br>
<br>
<ins>Customer Detail page:</ins>
<br>
<br>
![alt text](README_visuals/Customer_Detail_page(1).png)
<br>
<br>
<ins>Product Detail page:</ins>
<br>
<br>
![alt text](README_visuals/Product_Detail_page(1).png)
<br>
<br>
